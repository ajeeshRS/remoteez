...
export default function JobCard({ job }: Props) {
  ...
  return (
    <div className="flex w-full flex-col items-start border border-neutral-800 bg-black p-3 text-white sm:w-full md:w-5/6 md:p-5">
      ...
      <div className="my-5 grid w-full grid-cols-1 items-center justify-between gap-3 space-x-5 text-sm md:my-3 md:grid-cols-1">
        <div className="grid w-full grid-cols-2 items-center gap-3 space-x-5 md:grid-cols-4">
